...
export class Backend implements backendInterface {
    ...
    async createConversation(arg0: string): Promise<ConversationId> {
    ...
    async getWelcomeSuggestions(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWelcomeSuggestions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async makeAIRequest(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.makeAIRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async renameConversation(arg0: ConversationId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
